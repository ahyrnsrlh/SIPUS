...
const searchFiles = () => {
    router.get(route('files.index'), { search: searchQuery.value }, { preserveState: true });
};
    ...
    <component :is="LayoutComponent">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900">🔍 Filter & Cari File</h3>
                <button
            ...
            <div v-if="showFilters" class="space-y-4">
                <div :class="[isAdmin ? 'grid grid-cols-1 md:grid-cols-3 gap-4' : 'grid grid-cols-1 md:grid-cols-2 gap-4']">
                    ...
                    <!-- Sub-Rak -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Sub-Rak</label>
                        <select
                        ...
                        >
                            ...
                            <option v-for="subRack in subRacks" :key="subRack.id" :value="subRack.id">
                                {{ subRack.name }}
                            </option>
                        </select>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <!-- Tanggal Upload Dari -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Upload Dari 📅</label>
                        <input
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Tanggal Upload Sampai 📅</label>
                        <input
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600">
                        {{ isAdmin ? 'Manage and organize all files in the system' : 'Manage your uploaded files' }}
                    </p>
                </div>
            ...
            <div v-if="files && files.data && files.data.length > 0">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <div :class="[
                        ...
                        <div :class="isAdmin ? 'col-span-4' : 'col-span-5'">File Info</div>
                    ...
                    >
                        <div :class="[
                            ...
                            <div class="col-span-2">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-light-blue text-pln-blue">
                                    {{ file.rack?.name || 'General' }}
                                </span>
                                <div v-if="file.sub_rack" class="text-xs text-gray-500 mt-1">
                                    {{ file.sub_rack.name }}
                                </div>
                            </div>
                            ...
                            <!-- Size -->
                            <div class="col-span-2">
                                <div class="text-sm text-gray-900">{{ file.formatted_size || 'N/A' }}</div>
                            </div>
                ...
                <!-- Pagination -->
                <div v-if="files.links" class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-600 mb-3">
                                        <strong>Konfirmasi Penghapusan File</strong>
                                    </p>
                                    <p class="text-sm text-gray-700">
                                        ❗ Anda yakin ingin menghapus file:
                                    </p>
                                    <p class="text-sm font-semibold text-gray-900 mt-1">
                                        **{{ fileToDelete?.title || fileToDelete?.filename }}**?
                                    </p>
