    ...
    <AdminLayout>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-6">📝 Form Edit Metadata File</h3>
                <p class="text-sm text-gray-600 mb-6">Edit File (Hanya Uploader atau Admin)</p>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-500">{{ file.formatted_size }} • Uploaded {{ new Date(file.created_at).toLocaleDateString() }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Judul File -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Judul File *</label>
                            <input
                                v-model="form.title"
                                type="text"
                        ...
                        <div>
                            ...
                            <div v-if="form.errors.sub_rack_id" class="mt-1 text-sm text-red-600">
                    ...
                    <div v-if="form.tags.length > 0" class="space-y-2">
                        <label class="block text-sm font-medium text-gray-700">Tag yang Dipilih:</label>
