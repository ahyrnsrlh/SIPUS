    ...
    <AdminLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div class="bg-white rounded-xl shadow-sm border border-pln-gray p-6">
                <div class="flex items-center">
                    <div class="w-12 h-12 bg-pln-blue rounded-lg flex items-center justify-center">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-pln-gray p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-charcoal">{{ stats.approved }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-pln-gray p-6">
                <div class="flex items-center">
                    <div class="w-12 h-12 bg-pln-yellow rounded-lg flex items-center justify-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-charcoal">{{ stats.pending }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-pln-gray p-6">
                <div class="flex items-center">
                    <div class="w-12 h-12 bg-pln-red rounded-lg flex items-center justify-center">
                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-charcoal">{{ stats.rejected }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-pln-gray p-6 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex-1">
                    <h2 class="text-xl font-bold text-charcoal">👥 Manajemen Pengguna</h2>
                    <p class="text-sm text-gray-600">Kelola persetujuan dan status pengguna sistem</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-pln-gray overflow-hidden">
            <div v-if="users && users.length > 0">
                ...
                <div class="px-6 py-4 border-b border-pln-gray bg-pln-gray">
                    <div class="grid grid-cols-12 gap-4 text-xs font-medium text-charcoal uppercase tracking-wider">
                    ...
                    >
                        <div class="grid grid-cols-12 gap-4 items-center">
                            ...
                            <div class="col-span-3 flex items-center">
                                <div class="w-10 h-10 bg-light-blue rounded-full flex items-center justify-center mr-3">
                                    <span class="text-pln-blue font-medium text-sm">
                                        {{ user.name.charAt(0).toUpperCase() }}
                                    </span>
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-charcoal">{{ user.name }}</div>
                            ...
                            <div class="col-span-2">
                                <div class="text-sm text-charcoal">{{ user.email }}</div>
                            </div>

                            <!-- Instansi -->
                            <div class="col-span-2">
                                <div class="text-sm text-charcoal">{{ user.instansi || '-' }}</div>
                            </div>

                            <!-- Role -->
                            <div class="col-span-1">
                                <span :class="getRoleBadge(user.role)" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border capitalize">
                                    {{ user.role }}
                                </span>
                            </div>
                            ...
                            <!-- Status -->
                            <div class="col-span-2">
                                <span :class="getStatusBadge(user.status)" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border capitalize">
                                    {{ user.status }}
                                </span>
                                <div v-if="user.approved_at" class="text-xs text-gray-500 mt-1">
